...
export default function Navbar() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-30 flex items-center justify-between h-16 px-6 border-b bg-white/70 backdrop-blur-xl border-gray-200/70">
            {/* Kiri: Hamburger + Logo */}
            <div className="flex items-center space-x-4">
                <button className="p-2 text-gray-500 rounded-md hover:bg-gray-100/80 lg:hidden">
                    <svg
                        className="w-6 h-6"
                        fill="none"
                        stroke="currentColor"
            ...
            <div className="flex-1 hidden max-w-md mx-8 md:flex">
                <div className="relative w-full">
                    ...
                    <input
                        ...
                        className="w-full py-2 pl-9 pr-4 text-sm bg-gray-50/80 border border-gray-200/80 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                    />
                </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
                <button
                    className="p-2 text-gray-500 rounded-full hover:bg-gray-100/80"
                ...
                <div className="relative">
                    <button
                        ...
                        className="flex items-center pl-3 ml-1 space-x-2 border-l border-gray-200/80"
                    >
                        ...
                        <svg
                            className="hidden w-4 h-4 text-gray-400 sm:block"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
                    ...
                    {showMenu && (
                        <div className="absolute right-0 z-40 w-48 py-2 mt-2 border shadow-lg bg-white/90 backdrop-blur-xl border-gray-100/80 rounded-lg">
                            <div className="px-4 py-2 text-sm text-gray-500 border-b border-gray-100/80">
